        ...
        try:
            with get_db_connection() as conn:
                with conn.cursor() as cursor:
                    ...
                    logger.info("Multipla creata", group_id=group_id, tipo=data['tipo_multipla'], 
                               quota=data['quota_totale'], num_eventi=data['num_eventi'])
        ...
        try:
            with get_db_connection() as conn:
                with conn.cursor() as cursor:
                    ...
                    logger.info("Multipla aggiornata", group_id=group_id, risultato=risultato_finale, 
                               profit=profit, win=num_win, loss=num_loss, void=num_void)
