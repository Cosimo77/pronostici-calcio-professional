...
class PerformanceMonitor:
    ...
    def record(self, endpoint: str, duration: float, status_code: int):
        ...
        self.metrics[endpoint].append({"duration": duration, "status_code": status_code, "timestamp": time.time()})
    ...
    def decorator(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                status_code = 500
                _error_tracker.record_error(e, {"endpoint": endpoint_name or func.__name__})
                raise
...
def log_cache_hit(key: str, hit: bool):
    """Log cache hit/miss"""
    _logger.info("Cache access", key=key, hit=hit, action="hit" if hit else "miss")
